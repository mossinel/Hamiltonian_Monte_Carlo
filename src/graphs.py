...
def main():
    ...
    #axs[0, 1].hist2d(big_q[:, -2, 0], big_q[:, -2, 1], bins=(50, 50), cmap=plt.cm.jet)
    #ax1[1, 0].hist2d(final_q[:, 0], final_q[:, 1], bins=(50, 50), cmap=plt.cm.jet)
    #ax1[1, 1].pcolormesh(x, x, y, cmap=plt.cm.jet)
